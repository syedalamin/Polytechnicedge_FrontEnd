...
type InstructorUpdateFormData = z.infer<
  typeof instructorSchema.updateInstructorSchema
>;

const UpdateInstructorModal = ({
  refetch,
  updateData,
}: UpdateInstructorModalProps) => {
  const dispatch = useAppDispatch();
  const isOpen = useAppSelector(
    (state: any) => !!state.modal?.["updateInstructor"],
  );
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={() => dispatch(closeModal("updateInstructor"))}
