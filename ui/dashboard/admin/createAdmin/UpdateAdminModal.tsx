...
type AdminFormData = z.infer<typeof adminSchema.updateAdminValidation>;
...
const UpdateAdminModal = ({ refetch, updateData }: UpdateAdminModalProps) => {
  ...
  return (
    <Modal
      ...
      onClose={() => dispatch(closeModal("updateAdmin"))}
      title="Update Admin"
      modalSize="lg"
      confirmLabel="Update Admin"
    >
      <Form
        onSubmit={onSubmit}
        resolver={zodResolver(adminSchema.updateAdminValidation)}
        values={{
