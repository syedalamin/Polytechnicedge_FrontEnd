        ...
        <div className="backdrop-blur-xl bg-white/10 rounded-2xl shadow-xl p-6 sm:p-8 md:p-10 lg:p-12 space-y-5 border border-white/20">
          <div className="text-center space-y-2">
            <div className="relative inline-block">
              ...
              <div className="relative w-14 h-14 bg-linear-to-br from-cyan-400 via-purple-500 to-pink-500 rounded-xl flex items-center justify-center shadow-lg transform rotate-12 hover:rotate-0 transition-transform duration-500">
